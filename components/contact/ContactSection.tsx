      ...
      <div className="content-inner">
        <AnimateOnScroll>
          <div className="contact-header">
            <div className="contact-subtitle-wrap">
              <span className="contact-subtitle">GET IN TOUCH</span>
              <span className="contact-line" aria-hidden />
            </div>
            <h2 className="contact-heading">
              Let&apos;s Build Your <br />
              <span style={{ color: '#C50D3E' }}>Fitness Goals</span> <br />
              Together.
            </h2>
          </div>
          <div className="contact-layout">
            ...
            <div className="contact-left">
              <a 
                href="https://www.google.com/maps/search/?api=1&query=3rd+Generation+Gym+Alanathi+Main+Road+Ganesh+Nagar+Chennai" 
                target="_blank" 
                ...
                <div className="contact-item-header">
                  <span className="contact-icon">
                    <svg width="25" height="32" viewBox="0 0 25 32" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path fillRule="evenodd" clipRule="evenodd" d="M11.3469 31.5649C11.3469 31.5649 0 21.9766 0 12.5419C0 9.21562 1.31696 6.02552 3.66117 3.67345C6.00537 1.32138 9.18479 0 12.5 0C15.8152 0 18.9946 1.32138 21.3388 3.67345C23.683 6.02552 25 9.21562 25 12.5419C25 21.9766 13.6531 31.5649 13.6531 31.5649C13.0219 32.1482 11.9828 32.1419 11.3469 31.5649ZM12.5 18.0291C13.2182 18.0291 13.9293 17.8871 14.5928 17.6114C15.2563 17.3356 15.8592 16.9314 16.367 16.4219C16.8748 15.9124 17.2776 15.3075 17.5525 14.6418C17.8273 13.976 17.9688 13.2625 17.9688 12.5419C17.9688 11.8214 17.8273 11.1079 17.5525 10.4421C17.2776 9.7764 16.8748 9.17151 16.367 8.66198C15.8592 8.15246 15.2563 7.74828 14.5928 7.47253C13.9293 7.19677 13.2182 7.05485 12.5 7.05485C11.0496 7.05485 9.6586 7.63295 8.63301 8.66198C7.60742 9.69101 7.03125 11.0867 7.03125 12.5419C7.03125 13.9972 7.60742 15.3929 8.63301 16.4219C9.6586 17.4509 11.0496 18.0291 12.5 18.0291Z" fill="#C50D3E" />
                    </svg>
                  </span>
                  <h4>Location</h4>
                </div>
                <p>
                  No. 10, ganesh nagar, alamathi main road,<br />
                  vellanur, chennai - 600062
                </p>
              </a>

              <a 
                href="mailto:3rdgenerationfitnessstudio@gmail.com" 
                className="contact-item"
              >
                <div className="contact-item-header">
                  <span className="contact-icon">
                    <svg width="32" height="26" viewBox="0 0 32 26" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path d="M3.2 26C2.32 26 1.56693 25.682 0.9408 25.0461C0.314667 24.4102 0.00106667 23.6448 0 22.75V3.25C0 2.35625 0.3136 1.59142 0.9408 0.9555C1.568 0.319583 2.32107 0.00108333 3.2 0H28.8C29.68 0 30.4336 0.3185 31.0608 0.9555C31.688 1.5925 32.0011 2.35733 32 3.25V22.75C32 23.6437 31.6869 24.4091 31.0608 25.0461C30.4347 25.6831 29.6811 26.0011 28.8 26H3.2ZM16 14.625L28.8 6.5V3.25L16 11.375L3.2 3.25V6.5L16 14.625Z" fill="#C50D3E" />
                    </svg>
                  </span>
                  <h4>Email</h4>
                </div>
        ...
        <AnimateOnScroll delay={0.15}>
          <div className="contact-map-wrap">
            <iframe
              ...
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3884.825329641343!2d80.1004145!3d13.173410699999998!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3a527d006206b0ff%3A0x116291f3b2517f0d!2s3rd%20generation%20fitness%20studio!5e0!3m2!1sen!2sin!4v1774543701914!5m2!1sen!2sin"
