        ...
        <div className="franchise-contact__left">
          ...
          <div className="franchise-contact__blocks">
            <div className="franchise-contact__block">
              ...
              <div>
                <h3 className="franchise-contact__block-title">Address</h3>
                <p className="franchise-contact__block-text">10, Alamadhi  main road, Vetrivel Nagar, Ganesh Nagar, New Vellanur, Avadi, Chennai- 600062</p>
              </div>
            </div>
            <div className="franchise-contact__block">
              <div className="franchise-contact__icon" aria-hidden>
              ...
              <div>
                <h3 className="franchise-contact__block-title">Email</h3>
                <p className="franchise-contact__block-text">3rdgenerationfitnessstudio@gmail.com</p>
            ...
            <div className="franchise-contact__block">
              ...
              <div>
                <h3 className="franchise-contact__block-title">Contact</h3>
                <p className="franchise-contact__block-text">+91 8190895694</p>
              </div>
            </div>
          </div>
        </div>
