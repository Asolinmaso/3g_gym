      ...
      <AnimateOnScroll className="about-infra__layout">
        <div className="about-infra__left">
          ...
          <h2 className="about-infra__heading">
            <span className="about-infra__heading-line">
              Explore <span className="about-infra__heading-accent">Our</span>
            </span>
            <span className="about-infra__heading-line">
              <span className="about-infra__heading-accent">Gym Space</span>
            </span>
          </h2>
          <p className="about-infra__text" style={{ width: "390px" }}>
            Our gym combines modern infrastructure, spacious layouts,and a to help you train comfortably and stay focused on your goals.
          </p>
