      ...
      <AnimateOnScroll className="content-inner about-infra__layout">
        <div className="about-infra__left">
          ...
          <h2 className="about-infra__heading">
            <span className="about-infra__heading-line about-infra__heading-line--1">Explore</span>
            <span className="about-infra__heading-line about-infra__heading-line--2">
              <span className="about-infra__heading-accent">Our Gym Space</span>
            </span>
          </h2>
          <p className="about-infra__text">
            Our gym combines modern infrastructure, spacious layouts, and a motivating environment to help you train comfortably and stay focused on your goals.
          </p>
