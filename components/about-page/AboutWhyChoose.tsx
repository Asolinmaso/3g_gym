...
const CARDS = [
  { title: 'Pro Equipment', text: 'Our gym is equipped with modern, high-performance machines designed to support strength, endurance, and functional training for all fitness levels.', image: '/images/about_page/about_choose1.png' },
  { title: 'Expert Trainers', text: 'Our certified trainers provide personalized coaching, correct techniques, and motivation to help you reach your goals faster and safely.', image: '/images/about_page/about_choose2.jpg' },
  { title: 'Health Report', text: 'We provide regular fitness assessments and detailed health reports to monitor your progress and adjust your plan for maximum results.', image: '/images/about_page/about_choose3.jpg' },
];
